...
******************************************************************************/
#ifndef SOFA_COMPONENT_CONSTRAINTSET_NeedleSlidingConstraint_H
#define SOFA_COMPONENT_CONSTRAINTSET_NeedleSlidingConstraint_H
#include "config.h"
...
class NeedleSlidingConstraint : public core::behavior::PairInteractionConstraint<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(NeedleSlidingConstraint,DataTypes), SOFA_TEMPLATE(core::behavior::PairInteractionConstraint,DataTypes));
...
protected:
    ...
    NeedleSlidingConstraint();
    NeedleSlidingConstraint(MechanicalState* object);
    NeedleSlidingConstraint(MechanicalState* object1, MechanicalState* object2);

    virtual ~NeedleSlidingConstraint(){}
...
#if  !defined(SOFA_COMPONENT_CONSTRAINTSET_NeedleSlidingConstraint_CPP)
extern template class SOFA_CONSTRAINT_API NeedleSlidingConstraint< defaulttype::Vec3Types >;
...
#endif // SOFA_COMPONENT_CONSTRAINTSET_NeedleSlidingConstraint_H
