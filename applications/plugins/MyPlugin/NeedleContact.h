...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_NEEDLECONTACT_H
#define SOFA_COMPONENT_COLLISION_NEEDLECONTACT_H
...
class NeedleContact : public core::collision::Contact, public ContactIdentifier
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(NeedleContact, TCollisionModel1, TCollisionModel2, ResponseDataTypes), core::collision::Contact);
...
protected:
    ...
    constraintset::UnilateralInteractionConstraint<sofa::defaulttype::Vec3Types>::SPtr m_unilateralConstraint;
    constraintset::NSlidingConstraint<sofa::defaulttype::Vec3Types>::SPtr m_nSlidingConstraint;
    ...
    NeedleContact();
    NeedleContact(CollisionModel1* model1, CollisionModel2* model2, Intersection* intersectionMethod);

    ~NeedleContact() override;
public:
